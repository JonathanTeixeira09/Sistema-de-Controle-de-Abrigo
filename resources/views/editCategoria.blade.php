...
@section('title', 'Editar Categoria do Produto')
@section('conteudo')

    <div class="col-md-8  mx-auto justify-content-center align-items-center flex-column">

        <form class="row g-2" action="{{ route('updatecategoria', $categorias->id) }}" method="POST" name="formCadastro"
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control @error('nome') is-invalid @enderror" name="nome"
                    placeholder="Ex. Medicamentos" tabindex="1" value="{{ $categorias->nome }}">
                @error('nome')
